package com.abner.ming.universalselector.realm;
...
public class RealmSqlite {

    private RealmSqlite(){}

    private static RealmSqlite mRealmSqlite=null;

    public static RealmSqlite getRealmSqlite(){
        if(mRealmSqlite==null){
            mRealmSqlite=new RealmSqlite();
        }
        return mRealmSqlite;
    }
    ...
    public static RealmBuilder getRealm(){
        if(mRealm==null){
    ...
    public static class RealmBuilder{
        ...
        public RealmBuilder(Realm mRealm){
            this.mRealm=mRealm;
        }
